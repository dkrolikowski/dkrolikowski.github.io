...
The main project involving Taurus I have worked on is using *Gaia* EDR3 to investigate the substructure in the region, and paint a picture of the star forming history of the region. Using an expansive census of objects that have been previously considered members of the greater Taurus region. Sentence about the substructure in space. Sentence about what it looks like in velocity. Sentence about ages, and also the age gradient. Conclusions! And then also a link to the interactive plot and also the paper.
